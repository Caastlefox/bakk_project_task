...
namespace bakk_project_task
{
    ...
    {
        Task AddClient(string firstName, string lastName, string address, string phoneNumber, string status);
        Task UpdateClient(int? id, string firstName, string lastName, string address, string phoneNumber, string status);
